...
public class TeacherApplyCurriculumController extends BaseController {
     ...
     * 2018/7/4 12:12
     * 描述一下方法的作用
     * @param scApply  申请对象（Integer id, Integer curriculumId, String applyRemark, Date beginOfSelectTime, Date endOfSelectTime, Date currStartTime, String classPlace, Integer maxNum）
     * @author 曹良峰
     * @return 200 成功
     */
    @ResponseBody
